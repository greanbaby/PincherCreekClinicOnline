...
function handleDrop2( e ) {
  ...
  reader.onload = function( e ) {
    ...
    const ws_data = fncGetArrayOfRowsMatching( ws, lastColOne, ws2, lastColTwo );
...
/**
 * function fncGetArrayOfRowsMatching - given 2 worksheets build a new array of values
...
<template>
  <div class="tool">
    ...
    <h2>Remove Rows That Do Not Match File 2</h2>

    <p>The last columns are used generate a new file with matches from file one</p>
